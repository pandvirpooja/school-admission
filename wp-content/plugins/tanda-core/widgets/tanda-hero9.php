 ...
 * @since 1.0.0
 */
class Elementor_tanda_hero9_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Hero 9 Section', 'tanda-core' );
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => esc_html__( 'Home9 Hero Section', 'tanda-core' ),
    ...
    protected function render() {
        ...
        $hero9_output = $this->get_settings_for_display(); ?>

<!-- Start Banner 
============================================= -->
<div class="banner-area bg-adjustable text-light" style="background-image: url(<?php echo esc_url(wp_get_attachment_image_url( $hero9_output['heroimg1']['id'], 'full' ));?>">
    <div class="item">
        <div class="container">
            <div class="row align-center">
                ...
                <div class="col-lg-6">
                    <div class="content">
                        <h2 class="wow fadeInDown"><?php echo esc_html($hero9_output['title']); ?> <strong><?php echo esc_html($hero9_output['bold']); ?></strong></h2>
                        <p class="wow fadeInLeft">
                            <?php echo esc_html($hero9_output['des']); ?>
                        </p>
                        <?php if(!empty($hero9_output['bttext'] )): ?>
                        <a class="btn circle btn-light effect btn-md wow fadeInUp" href="<?php echo esc_url($hero9_output['btlink']['url']); ?>"><?php echo esc_html($hero9_output['bttext']); ?> <i class="<?php echo esc_html($hero9_output['bticon']); ?>"></i></a>
                        <?php endif;?>
                    </div>
                </div>
                ...
                <div class="col-lg-5 offset-lg-1 appoinment">
                    <div class="appoinment-box text-center wow fadeInRight">
                        <div class="heading">
                            <h4><?php echo esc_html($hero9_output['formtitle']); ?></h4>
                            <p>
                                <?php echo esc_html($hero9_output['formdes']); ?>
                            </p>
                        </div>
                        <?php echo do_shortcode($hero9_output['contactform_shortcode']);?>
                    </div>
                </div>
                <!-- End Appoinment Form -->
