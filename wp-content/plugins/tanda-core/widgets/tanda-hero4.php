...
/**
 * Elementor Tanda hero4 Widget.
 *
 * Elementor widget that inserts an embbedable content into the page, from any given URL.
 *
 * @since 1.0.0
 */
class Elementor_tanda_hero4_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Hero Four Section', 'tanda-core' );
    }
        ...
        <div class="item">
            <div class="container">
                <div class="row align-center">
                    ...
                    <div class="col-lg-6">
                        <div class="content">
                            <h2 class="wow fadeInDown"><?php echo esc_html($hero4_output['title']); ?> <strong><?php echo esc_html($hero4_output['sub']); ?></strong></h2>
                            <p class="wow fadeInLeft">
                                <?php echo esc_html($hero4_output['des']); ?>
                            </p>
                            <div class="bottom">
                                <?php if(!empty($hero4_output['bttext'] )): ?>
                                <a class="btn btn-theme effect btn-md wow fadeInUp" href="<?php echo esc_url($hero4_output['btlink']['url']); ?>"><?php echo esc_html($hero4_output['bttext']); ?></a>
                                 <?php endif;?>
                                <div class="call-us wow fadeInLeft">
                                    <div class="icon">
                                        <i class="<?php echo esc_html($hero4_output['bticon']); ?>"></i>
                                    </div>
                                    <div class="info">
                                        <h5><?php echo esc_html($hero4_output['bttext2']); ?></h5>
                                        <span><?php echo esc_html($hero4_output['bttitle2']); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 thumb">
                        <img class="wow fadeInUp" src="<?php echo esc_url(wp_get_attachment_image_url( $hero4_output['heroimg']['id'], 'full' ));?>" alt="Thumb">
                    </div>
