 ...
 * @since 1.0.0
 */
class Elementor_tanda_hero7_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Hero 7 Section', 'tanda-core' );
    }
...
<div class="item">
    <div class="container">
        <div class="row align-center">
            ...
            <div class="col-lg-6">
                <div class="content">
                    <h2 class="wow fadeInDown"><?php echo esc_html($hero_output['title']); ?><strong><?php echo esc_html($hero_output['bold']); ?></strong></h2>
                    <p class="wow fadeInLeft">
                        <?php echo esc_html($hero_output['des']); ?>
                    </p>
                    <?php if(!empty($hero_output['bttext'] )): ?>
                    <a class="btn circle btn-light effect btn-md wow fadeInUp" href="<?php echo esc_url($hero_output['btlink']['url']); ?>"><?php echo esc_html($hero_output['bttext']); ?> <i class="<?php echo esc_html($hero_output['bticon']); ?>"></i></a>
                    <?php endif;?>
    ...
    <!-- Fixed Shape -->
    <div class="shape" style="background-image: url(<?php echo esc_url(wp_get_attachment_image_url( $hero_output['heroimg1']['id'], 'full' ));?>"></div>
    <!-- End Fixed Shape -->
</div>
<!-- End Banner -->
