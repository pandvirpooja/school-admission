 ...
 * @since 1.0.0
 */
class Elementor_tanda_service8_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Home 8 Service Section', 'tanda-core' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'list1',
            [
                'label'     => esc_html__( 'Home8 Service Box', 'tanda-core' ),
...
<div class="services-area carousel-shadow default-padding">
    <?php if(!empty($service8_output['title'] )): ?>
    <div class="container">
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <div class="site-heading text-center">
                    <h4><?php echo esc_html($service8_output['title']);?></h4>
                    <h2><?php echo esc_html($service8_output['sub']);?></h2>
                </div>
            </div>
        </div>
    </div>
    ...
    foreach ($service8_output['list1'] as $service8_output_box):?>
            ...
            <div class="item">
                <div class="icon">
                    <img src="<?php echo esc_url(wp_get_attachment_image_url( $service8_output_box['img1']['id'], 'full' ));?>" alt="Icon">
                </div>
                <div class="info">
                    <h4><?php echo esc_html($service8_output_box['servicetitle']);?></h4>
                    <p>
                        <?php echo esc_html($service8_output_box['servicedes']);?>
                    </p>
                    <div class="bottom">
                        <span><?php echo esc_html($service8_output_box['no']);?></span>
                        <?php if(!empty($service8_output_box['bttext'] )): ?>
                        <a href="<?php echo esc_url($service8_output_box['btlink']['url']);?>"><?php echo esc_html($service8_output_box['bttext']);?> <i class="<?php echo esc_attr($service8_output_box['bticon']);?>"></i></a>
                        <?php endif;?>
                    </div>
                </div>
            </div>
