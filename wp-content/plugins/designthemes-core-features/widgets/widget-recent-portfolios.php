<?php
class Aagan_Portfolio_Widget extends WP_Widget {
	#1.constructor
	function __construct() {
		$widget_options = array("classname"=>'widget_popular_entries', 'description'=>esc_html__('To list out portfolio items', 'aagan'));
		parent::__construct(false,AAGAN_THEME_NAME.esc_html__(' Portfolio','aagan'),$widget_options);
	}
	...
	function widget($args, $instance) {
		...
		echo "<div class='recent-portfolio-widget'><ul>";
			 ...
			 if($the_query->have_posts()) :
			 	...
			 	echo "<li>".esc_html__('No Portfolio Entries found','aagan')."</li>";
			 endif;
			 wp_reset_postdata();
	 	echo "</ul></div>";			 
		echo ($after_widget);
