...
if (! class_exists ( 'DTPortfolioPostType' )) {
	class DTPortfolioPostType {
		...
		function __construct() {
			...
			add_filter( 'aagan_header_footer_default_cpt', array(
				$this,
		...
		function createPostType() {
			...
			$portslug = aagan_cs_get_option( 'single-portfolio-slug', 'dt_portfolios' );
			$taxslug  = aagan_cs_get_option( 'portfolio-category-slug', 'portfolio_entries' );
			...
			'sections'  => array(
				array(
					...
					array(
						...
						'options' => array(
							'full-width-portfolio'   => AAGAN_THEME_URI . '/cs-framework-override/images/portfolio-fullwidth.png',
							'with-left-portfolio'    => AAGAN_THEME_URI . '/cs-framework-override/images/portfolio-with-left-gallery.png',
							'with-right-portfolio'   => AAGAN_THEME_URI . '/cs-framework-override/images/portfolio-with-right-gallery.png',
						),
		...
		function dt_portfolio_wp_enqueue_scripts() {
			...
			wp_enqueue_style( 'aagan-portfolio',	  plugin_dir_url ( __FILE__ ) . 'css/portfolio.css', false, AAGAN_THEME_VERSION, 'all' );
